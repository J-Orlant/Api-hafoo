    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h4><i class="fas fa-edit"></i> Edit Products</h4>
            </div>
            <form action="{{ route('products.update', $product->slug) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control" value="{{$product->name}}" placeholder="Product Name">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input readonly type="text" id="slug" name="slug" class="form-control" value="{{$product->slug}}" placeholder="Product Slug">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="category_id">
                                        @empty($product->category->id)
                                            <option value="0" selected>There is no category</option>
                                        @endempty
                ...
                <div class="form-group mx-4">
                    ...
                    <button class="btn btn-primary mt-4"><i class="fas fa-edit"></i> Edit Product</button>
                </div>
            </form>
        </div>
    </div>
