...
Route::middleware(['web', 'auth'])->group(function () {
    ...
    Route::patch('/admin-panel/products/update/{product:slug}', [ProductController::class, 'update'])->name('products.update');
    ...
    Route::patch('/admin-panel/categories/update/{category}', [CategoryController::class, 'update'])->name('categories.update');
    Route::delete('/admin-panel/categories/delete/{category}', [CategoryController::class, 'delete'])->name('categories.delete');
    //Transaction
    Route::get('/admin-panel/transactions', [TransactionController::class, 'index'])->name('transactions');
    Route::get('/admin-panel/transactions/detail/{transaction}', [TransactionController::class, 'detail'])->name('transactions.detail');
    Route::get('/admin-panel/transactions/status/{transaction}', [TransactionController::class, 'status_update'])->name('transactions.status.update');

    //Log out
    Route::get('/logout', [AuthController::class, 'web_logout'])->name('logout');
});
